...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './tweets.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TWEETS_LIST actions', async () => {
    ...
    it('dispatches FETCH_TWEETS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TWEETS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TWEETS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TWEETS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TWEETS actions', async () => {
      const expectedActions = [
        {
