...
import com.mycompany.myapp.service.TweetsService;
...
/**
 * REST controller for managing {@link com.mycompany.myapp.domain.Tweets}.
 */
@RestController
@RequestMapping("/api")
public class TweetsResource {
    ...
    public ResponseEntity<TweetsDTO> updateTweets(
        ...
        TweetsDTO result = tweetsService.update(tweetsDTO);
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, tweetsDTO.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<TweetsDTO> partialUpdateTweets(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, tweetsDTO.getId().toString())
        );
    }
     ...
     */
    @GetMapping("/tweets")
    public ResponseEntity<List<TweetsDTO>> getAllTweets(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
    ...
    public ResponseEntity<TweetsDTO> getTweets(@PathVariable Long id) {
